#Ovo je temp od zadatka b9
#vezan za merenje vremena
...
startTime = time.time()
#I naravno varijabla za dogadjaj kada se resetuje(nema potrebe,resetuje se sve kada se prekoraci)
